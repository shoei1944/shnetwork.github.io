...
.then(data => {
    if (data.online == true) {
        ...
        {% else %}
        document.getElementById("serverStatus").innerHTML = `<p class="font-bold select-none"><span class="text-green-600">&#11044;</span>&emsp;Онлайн &ensp;&middot;&ensp;${data.players.online} Играют</p>`;
        document.getElementById("serverStatusM").innerHTML = `<p class="font-bold select-none"><span class="text-green-600">&#11044;</span>&emsp;Онлайн, ${data.players.online} Играют</p>`;
        {% endif %}
    }
    else {
        {% if site.siteNav %}
        ...
        {% else %}
        document.getElementById("serverStatus").innerHTML = `<p class="font-bold select-none"><span class="text-red-600">&#11044;</span>&emsp;Офлайн</p>`;
